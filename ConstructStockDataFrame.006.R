...
getSymbols(c("T"))  #need to improve this line to pull form google
...
Playground$Div <- getDividends('T', from = "2007-01-01", to = Sys.Date(), src = "google", auto.assign = FALSE)
Playground$Div <- getSplits('T', from = "2007-01-01", to = Sys.Date(), src = "google", auto.assign = FALSE)
